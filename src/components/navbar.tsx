...
export const Navbar = () => {
  ...
  const isProjectsPage = pathname?.startsWith('/projects') || pathname?.startsWith('/login') || pathname?.startsWith('/my-applications') || pathname?.startsWith('/apply');
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden mt-2 sm:mt-4 mx-2 sm:mx-4 bg-gradient-to-br from-neutral-900/95 via-neutral-800/90 to-neutral-900/95 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-4 sm:p-6 shadow-2xl shadow-cyan-500/10"
          >
